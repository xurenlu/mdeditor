...
var extendedE = {
    ...
    msgshow:function(msg){
        //MsgBoxDiag
        $('#MsgBoxDiag').find('.modal-body p.msg').html(msg);
        $('#MsgBoxDiag').modal({keyboard : true});
    },
    openFile:function(){
...
(function () {
    ...
    function mainHandler(data) {
        if (data) {
            ...
            $('#preview-save-button').on('click', SaveFileAs);
            $('#preview-open-button').on('click', function(){
                $("#openfile").click();
            });
            ...
            $(document).on(keyEvent, function(key) {
                ...
                if ((key.ctrlKey || key.metaKey) && !key.shiftKey) {
                    ...
                    switch (keyCodeStr) {
                        ...
                        case "s":
                            if (key.altKey) { // 'ctrl + alt + s' for markdown help.
                                SaveFileAs();
                                break;
                            }
                        default:
            ...
            var switchFullReaderMode = function() {
                ...
                $('#preview-save-button').hide();
                $('#preview-open-button').hide();
            ...
            var switchNormalModeFromFullReaderMode = function() {
                ...
                $('#preview-save-button').show();
                $("#preview-open-button").show();
                // change full-small button
                $('#preview-reader-small-button').hide();
